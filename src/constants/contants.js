...
export const homecat =
  ...
  export const gift = "catagories/2?&fields[0]=title&populate=products.img";
  export const  frames = "catagories/1?&fields[0]=title&populate=products.img";
  export const hamper="catagories/3?&fields[0]=title&populate=products.img";
  export const wrappingsheet="catagories/4?&fields[0]=title&populate=products.img";